...
# Função de renderização reestruturada e performática
def render_cards_com_busca(sub_df, prefix_key, local_col_tempo):
    ...
    for idx, row in df_filtrado_busca.iterrows():
        # Captura o estado atualizado direto do session_state
        ...
        if novo_status in ["Pendente", "Necessita Reprogramação"]:
            ...
            # Extração de motivo padrão caso já exista histórico salvo
            idx_motivo = 0
        ...
        # Alteração em tempo real APENAS na memória RAM do Session State (evitando I/O em disco a cada clique)
...
if st.session_state.df is not None:
    ...
    # Alerta persistente e flutuante caso existam dados modificados não consolidados na base
