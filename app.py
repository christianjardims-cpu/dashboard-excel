...
# Mapeamento de Cores: Pendente (Vermelho), Realizada (Verde), Necessita Reprogramação (Laranja)
COLOR_MAP = {
...
# Passando col_tempo como argumento para garantir escopo seguro
        ...
        if exec_sel != "Selecione...":
            ...
            for dia in dias_da_semana_ordem:
                ...
                if not df_dia.empty:
                    ...
                    st.markdown("<br>", unsafe_allow_html=True)
                    # Passando col_tempo como parâmetro
