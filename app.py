...
# Injeção de CSS - Design System Gemini + iOS / Apple Minimalista
st.markdown("""
<style>
    ...
    /* Customização do botão de fechar a barra lateral (seta superior estilo iOS) */
...
with st.sidebar:
    ...
    with st.expander("Previsão Semanal (Seg - Sex)", expanded=False):
...
if st.session_state.df is not None:
    ...
    st.warning("⬅️ Por favor, utilize o menu lateral integrado CMPC para realizar a inserção de credenciais e carregar o arquivo operacional base.")