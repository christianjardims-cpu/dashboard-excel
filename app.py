...
with st.sidebar:
    ...
    # Permitir tanto CSV quanto XLSX
...
if df is not None:
    # Padronizar o nome das colunas (ex: remover espaços extras)
    ...
    st.warning(
        "⬅️ Por favor, faça o upload do arquivo da sua programação na barra lateral esquerda para começar."
    )