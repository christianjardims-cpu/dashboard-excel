...
# Auxiliar para extrair horas numéricas de strings
...
# -----------------------------------------------------------------------------
# 5. SIDEBAR DESIGN COM TRATAMENTO DE ERRO DINÂMICO PARA A LOGO
# -----------------------------------------------------------------------------
with st.sidebar:
    # Mapeamento dinâmico para encontrar o novo arquivo logo_cmpc independente da extensão salva
